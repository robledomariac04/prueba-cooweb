...
<template>
    ...
    <div>
        <div class="notification title is-size-5 is-primary">Login</div>
        ...
        <button class="button is-primary is-fullwidth" :class="{'id-loading': isLoading}" @click="handleSubmit">Ingresar</button>
